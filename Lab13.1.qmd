...
In this lab we explored how soil microbial communities are shaped by geography. Using NEON MAGs data, we mapped the distribution of Acidobacteriota, tested spatial autocorrelation with a Mantel test, and examined distance‑decay patterns. These approaches let us see how community composition changes across space.
...
### Conclusion 
Our results show microbes are not randomly distributed: nearby sites share more similar communities, and similarity decreases with distance. Mapping and correlation analyses highlight the role of geography in structuring microbial diversity, even when using MAG counts as a proxy for abundance.
